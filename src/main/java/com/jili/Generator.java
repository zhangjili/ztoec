...
//        String projectPath = scanner.nextLine();
        String projectPath = "D:/work/code/rismember_user_info_deltailk/t";
//        gc.setOutputDir(projectPath + "/src/main/java");      //生成文件的输出目录
        ...
        gc.setEnableCache(false);             //二级缓存关闭
        ...
        dsc.setSchemaName("pay_engine");
        dsc.setUrl("jdbc:mysql://172.26.39.200:3306/pay_member2c?useUnicode=true&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("mysqladmin");
        dsc.setPassword("123465");
//        dsc.setUrl("jdbc:mysql://172.26.43.100:18067/pay_risk?useUnicode=true&characterEncoding=utf8");
//        dsc.setDriverName("com.mysql.jdbc.Driver");
//        dsc.setUsername("riskuser");
...
// 自定义输入文件名称
/*                System.out.println(projectPath + "/src/main/java/com/pay/rating/mapper/" + *//*pc.getModuleName() + "/" +*//*
