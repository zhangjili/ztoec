...
//        String projectPath = scanner.nextLine();
        String projectPath = "D:/work/test";
//        gc.setOutputDir(projectPath + "/src/main/java");      //生成文件的输出目录
        ...
        dsc.setSchemaName("pay_risk");
        dsc.setUrl("jdbc:mysql://testzk01.com:3306/pay_risk?useUnicode=true&characterEncoding=utf8");
...
// 自定义输入文件名称
                System.out.println(projectPath + "/src/main/java/com/jili/mapper/" + /*pc.getModuleName() + "/" +*/
                        tableInfo.getEntityName() + "Mapper.java");
                return projectPath + "/src/main/java/com/jili/mapper/" + /*pc.getModuleName() + "/" +*/
                        tableInfo.getEntityName() + "Mapper.java";
            }
        });
